...
SPECS = {
    "viper_v4_pro": (
        "беспроводная киберспортивная мышь, вес 54 г, сенсор Focus Pro 36K, "
        "оптические свитчи Gen-3, до 90 часов от батареи, HyperPolling до 8000 Гц"
    ),
    "huntsman_v3_pro": (
        "аналоговая оптическая клавиатура, регулировка срабатывания 0.1–4.0 мм, "
        "rapid trigger, алюминиевая верхняя панель, подключение USB-C"
    ),
    "blackshark_v2_pro": (
        "беспроводная гарнитура с 50-мм динамиками, объёмный звук с позиционированием, "
        "до 70 часов работы, микрофон с шумоподавлением"
    ),
    "firefly_v2_pro": (
        "игровой ковёр с микро-текстурной поверхностью и RGB-подсветкой, "
        "стабильное скольжение, синхронизация Razer Chroma"
    ),
    "seiren_v3_mini": (
        "компактный конденсаторный микрофон с суперкардиоидной диафрагмой, 24-бит/96 кГц, "
        "tap-to-mute на корпусе, идеален для стримов и голосовой связи"
    ),
}
